 ...
 */
class OrdinaryMoveDetailFragment :
    BaseFragment<OrdinaryMoveDetialViewModel, FragmentPickingMoveDetailBinding>() {
    ...
    override fun initClick() {
        v.brnOk.setOnClickListener {
            ...
            insmodel = InstorageModel(
                mlistData, username, "",
                accout, "010", companyNo, listdata!![0].ckh!!,
                listdata!![0].kwh!!, "", "", listdata!![0].fckh!!, listdata!![0].fkwh!!, "", ""
            )
