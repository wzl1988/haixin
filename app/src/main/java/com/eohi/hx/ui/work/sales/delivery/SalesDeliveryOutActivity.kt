...
import com.eohi.hx.databinding.ActivitySalesDeliveryOutBinding
import com.eohi.hx.ui.work.adapter.ViewPagerAdapter
import com.eohi.hx.utils.StatusBarUtil

class SalesDeliveryOutActivity : BaseActivity<BaseViewModel, ActivitySalesDeliveryOutBinding>() {
    ...
    override fun initView() {
        ...
        val infragment = SalesDeliveryFragment()
        val detailfragment = SalesDeliveryDetailFragment()
