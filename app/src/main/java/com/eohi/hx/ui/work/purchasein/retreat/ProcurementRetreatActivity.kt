...
import com.eohi.hx.databinding.ActivityProcurementRetreatBinding
import com.eohi.hx.ui.work.adapter.ViewPagerAdapter
import com.eohi.hx.utils.StatusBarUtil

class ProcurementRetreatActivity :
    BaseActivity<BaseViewModel, ActivityProcurementRetreatBinding>() {
    ...
    override fun initView() {
        ...
        val infragment = PurchaseByCodeFragment()
        val detailfragment = PurchaseBycodeDetailFragment()
