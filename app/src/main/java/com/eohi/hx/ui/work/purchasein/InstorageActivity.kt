...
import com.eohi.hx.databinding.ActivityInstorageBinding
import com.eohi.hx.ui.work.adapter.ViewPagerAdapter
import com.eohi.hx.utils.StatusBarUtil

class InstorageActivity : BaseActivity<BaseViewModel, ActivityInstorageBinding>() {
    ...
    override fun initView() {
        ...
        val infragment = InstorageFragment()
        val detailfragment = InstorageDetailFragment()
