...
import com.eohi.hx.databinding.ActivityOrdinaryMoveBinding
import com.eohi.hx.ui.work.adapter.ViewPagerAdapter
import com.eohi.hx.utils.StatusBarUtil

class OrdinaryMoveActivity : BaseActivity<BaseViewModel, ActivityOrdinaryMoveBinding>() {
    ...
    override fun initView() {
        ...
        val picking = OrdinaryMoveFragment()
        val pickingDetail = OrdinaryMoveDetailFragment()
