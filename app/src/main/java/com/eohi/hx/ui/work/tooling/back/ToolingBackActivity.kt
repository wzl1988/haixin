...
class ToolingBackActivity : BaseActivity<BaseViewModel, ActivityToolingRecipientsNewBinding>() {
    ...
    override fun initView() {
        ...
        v.root.title.text = "工装入库"
        v.root.toolbar.setNavigationOnClickListener {
            finish()
        }
        v.btnLy.text = "工装入库"
        v.btnDetail.text = "入库明细"
        ...
        val picking = ToolingBackFragment()
        val pickingDetail = ToolingBackDetailFragment()
