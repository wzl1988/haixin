...
import com.eohi.hx.databinding.ActivityFinishingInBinding
 ...
 * 完工入库
 */
class FinishingInActivity : BaseActivity<BaseViewModel, ActivityFinishingInBinding>() {
    ...
    override fun initView() {
        ...
        val infragment = FinishingInFragment()
        val detailfragment = FinishingInDetailFragment()
