...
import com.eohi.hx.databinding.ActivityAgvSendingBinding
import com.eohi.hx.ui.work.adapter.ViewPagerAdapter
import com.eohi.hx.utils.StatusBarUtil

class AgvSendingActivity : BaseActivity<BaseViewModel, ActivityAgvSendingBinding>() {
    ...
    override fun initView() {
        ...
        val picking = AgvSendingFragment()
        val pickingDetail = AgvSendingDetailFragment()
